...
VALUES
    (1, 'iphone18.jpg', 'Điện thoại Smartphone A - ảnh chính', TRUE, 1),
    (1, 'iphone18dou.jpg', 'Điện thoại Smartphone A - mặt sau', FALSE, 2),
    (2, 'laptop.jpg', 'Laptop B - ảnh chính', TRUE, 1),
    (3, 'mouse.jpg', 'Chuột không dây C - ảnh chính', TRUE, 1);
