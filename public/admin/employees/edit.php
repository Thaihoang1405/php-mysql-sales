        ...
        if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
            ...
            if ($file['size'] > $maxSize) {
                ...
                if (!isset($extensionMap[$mimeType])) {
                    ...
                    $destination = '/var/www/html/uploads/admin/employees/' . $newFileName;
                    ...
                    if (move_uploaded_file($file['tmp_name'], $destination)) {
                        ...
                        if (!empty($employee['Photo'])) {
                            $oldFilePath = '/var/www/html/uploads/admin/employees/' . $employee['Photo'];
        ...
        <div class="mb-3">
            ...
            <div class="mb-2">
                ...
                <?php if (!empty($employee['Photo'])): ?>
                    <img 
                        src="/uploads/admin/employees/<?= htmlspecialchars($employee['Photo']) ?>" 
                        alt="Current Photo" 
                        class="img-thumbnail" 
